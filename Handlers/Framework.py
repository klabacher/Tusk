...
def versionhandler(client, arg):
    ...
    client.sendLine('[UI_CLIENTEVENT]|101|receivedJson|{"action":"loadWindow","assetPath":"","initializationPayload":{"game":"snow","name":"'+str(client.name)+'","powerCardsFire":'+str(Penguin.getPowerCards("fire"))+',"powerCardsSnow":'+str(Penguin.getPowerCards("snow"))+',"powerCardsWater":'+str(Penguin.getPowerCards("water"))+'},"layerName":"topLayer","loadDescription":"","type":"playAction","windowUrl":"http://media.localhost/game/mpassets/minigames/cjsnow/en_US/deploy/swf/ui/windows/cardjitsu_snowplayerselect.swf","xPercent":0,"yPercent":0}')
