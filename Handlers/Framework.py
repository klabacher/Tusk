...
def readyhandler(client, arg):
    ...
    if parsedJson['triggerName']=="roomToRoomMinTime":
        ...
        client.sendLine("[O_ANIM]|12|0:100340|loop|800|1|0|12|1|0|0")
        ...
        client.sendLine("[O_ANIM]|13|0:100322|loop|700|1|0|13|2|0|0")
        ...
        client.sendLine("[O_ANIM]|4|0:100361|loop|1100|1|0|4|3|0|0")
        ...
        client.sendLine("[O_SPRITE]|65|0:100395|1|")
